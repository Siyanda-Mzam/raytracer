...
t_vec3	v3_adds(t_vec3 a, float s);
t_vec3	v3_sub(t_vec3 a, t_vec3 b);
t_vec3	v3_subs(t_vec3 a, float s);
t_vec3	v3_norm(t_vec3 v);
t_vec3	v3_proj(t_vec3 v, t_vec3 onto);
t_vec3	v3_cross(t_vec3 a, t_vec3 b);
t_vec3	v3_mul(t_vec3 a, t_vec3 b);
t_vec3	v3_muls(t_vec3 a, float s);
t_vec3	v3_div(t_vec3 a, t_vec3 b);
t_vec3	v3_divs(t_vec3 a, float s);
float	v3_angle_between(t_vec3 a, t_vec3 b);
